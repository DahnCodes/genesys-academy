      ...
      <section className="about">
        <div className="about-pd">
          ...
          <div className="about-text">
            ...
            <p>
              <b>Frontend Development (FE)</b> involves the process of creating
              and implementing the User Interface <br />(UI) and User Experience (UX)
              for online and mobile apps is referred to as Frontend Development.
              This <br />area of development is concerned with producing aesthetically
              beautiful, engaging, and user-friendly <br />designs that meet end-user
              requirements.
            </p>
            <p>
              To create user-friendly and captivating interfaces, Frontend
              Developers will use frameworks and <br />libraries like React together
              with programming languages like HTML, CSS, and JavaScript. To
              achieve <br />smooth interaction between the user interface and the
              underlying application logic, these developers <br />collaborate closely
              with Product Designers and Backend Developers.
            </p>
          </div>
        </div>
      </section>
