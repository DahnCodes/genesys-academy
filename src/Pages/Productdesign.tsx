        ...
        <div className="about-pd">
          ...
          <div className="about-text">
            ...
            <p>
              ...
              from developers to marketers, to <br />
              create innovative and user-friendly products. In essence, product
              design is about solving problems, <br />
              empathizing with users, and translating their needs into elegant,
              intuitive, and visually appealing <br />
              solutions.
            </p>
          </div>
        </div>
        ...
        <div className="learn-wrap">
          <div className="learn-point">
            ...
            <ul className="list">
              ...
              <li>
                User Research: Develop skills to understand and emphathise with
                user needs <br />
                and behaviours.
              </li>
              <li>
