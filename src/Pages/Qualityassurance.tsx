      ...
      <section className="about">
        <div className="about-pd">
          ...
          <div className="about-text">
            ...
            <p>
             <b> Quality Assurance (QA)</b> ensures that products and services meet
              specified requirements and <br />standards before they reach the
              customer. This field focuses on systematic processes to test <br />and
              validate product functionality, reliability, and performance.
            </p>
            <p>
              QA professionals use manual and automated testing methods,
              employing tools like Selenium, JUnit, <br />and Jenkins, to identify
              defects and ensure that the final product is of high quality. They
              work closely <br />with developers and product teams to create and
      ...
      <section className="learn">
        <div className="learn-wrap">
          <div className="learn-point">
            ...
            <ul className="list">
              <li>Manual Testing: Learn the fundamentals of manual testing and various testing <br />techniques.</li>
              <li>
              Automated Testing: Gain proficiency in automated testing tools like Selenium and <br />JUnit.
              </li>
              <li>
              Testing Frameworks: Understand different testing frameworks and methodologies.
              </li>
              <li>
              Bug Tracking and Reporting: Learn to use bug tracking tools like JIRA to report <br />and manage defects.
              </li>
              <li>
              Quality Assurance Processes: Master the QA lifecycle and processes to ensure <br />product quality.
              </li>
              {/* <li>
        ...
        <div className="learn-wrapper">
          ...
          <div className="second-list">
            <ul className="qa-list2">
              ...
              <li>Practical project work applying software testing principles</li>
            </ul>
          </div>
        </div>
