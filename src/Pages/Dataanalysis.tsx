        ...
        <section className="about">
          <div className="about-pd">
            ...
            <div className="about-text">
              ...
              <p>
                Data Analysis (DA) involves examining, cleaning, transforming,
                and modeling data to discover useful <br />
                information, draw conclusions, and support decision-making. This
                field focuses on applying statistical <br />
                and computational techniques to large datasets to identify
                patterns, trends, and relationships.
              </p>
              <p>
                Data Analysts use tools such as Python, R, SQL, and Excel, along
                with visualization tools like Tableau <br />
                and Power BI, to analyze data effectively. They work closely
                with stakeholders across various <br />
                departments to provide insights that drive business strategies
