        ...
        <section className="about">
          <div className="about-pd">
            ...
            <div className="about-text">
              ...
              <p>
                <b>Backend Development (BE) </b>in software engineering is the
                art of building and maintaining the server- <br />
                side of applications. It involves mastering programming
                languages like Python or Node.js and <br />
                database management with SQL or NoSQL databases.
              </p>
              <p>
                Backend developers focus on data storage, retrieval, API design,
                and ensuring application security <br />
                and scalability. They work behind the scenes, making them
                essential for any software or web <br />
        ...
        <section className="learn">
          <div className="learn-wrap">
            <div className="learn-point">
              ...
              <ul className="list">
                <li>
                  Server-Side Programming: Dive into server-side technologies
                  and languages like <br />
                  Node.js, Python, or Ruby.
                </li>
                <li>
                  Databases: Learn how to work with databases, both SQL and
                  NoSQL, for data <br />
                  management
                </li>
                <li>
                ...
                <li>
                  Security: Understand security practices and measures to
                  protect data and <br />
                  applications
                </li>
                <li>
