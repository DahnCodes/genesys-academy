...
const Paysmallinvoice = () => {
  ...
  const [payOp, setPayOp] = useState("pay-small"); // Default to full payment
  const [invoiceDate, setInvoiceDate] = useState<string>("");
  // const [dueDate, setDueDate] = useState<string>("");

  useEffect(() => {
    if (pathname.includes("pay-small")) {
      setPayOp("Pay-small");
    }
  }, [pathname]);
      ...
      <table className="invoice-table">
        ...
        <tbody>
          <tr>
            ...
            {/* <td>{paymentOptions.paySmallSmall.firstpayment.price}</td> */}
            <td>{invoicedetails?.amount}</td>
          </tr>
        </tbody>
      </table>
...
export default Paysmallinvoice;
